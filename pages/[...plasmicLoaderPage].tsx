...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "u2nC4PUCbS8VNjci8embFD" },
  
    "pricing": {name: "Pricing", projectId: "u2nC4PUCbS8VNjci8embFD" },
  
    "features": {name: "Features", projectId: "u2nC4PUCbS8VNjci8embFD" },
